...
- Run: `python3.9 question_3_faster_rcnn/demo_fasterrcnn.py --mode to-file` auto-selects CUDA PyTorch or the TF2 fallback
...
- YOLO11 run: `python3.9 question_4_yolo11_yolov12/demo_yolo11.py`
- YOLOv12 setup: `bash question_4_yolo11_yolov12/setup_yolov12_osc.sh`
- YOLOv12 run: `python3.9 question_4_yolo11_yolov12/demo_yolov12.py`
