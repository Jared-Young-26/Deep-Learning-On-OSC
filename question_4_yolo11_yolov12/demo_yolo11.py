...
# Embedded runtime shim that executes inside the target Ultralytics
# environment. The outer wrapper keeps repo-local path resolution and curated
# artifact copying separate from the actual model invocation.
